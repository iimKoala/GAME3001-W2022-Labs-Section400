...
void PlayScene::update()
{
	...
	m_pSpaceShip->getTree()->getEnemyHitNode()->setIsHit(false); // this would be different for A4
	...
	bool isDetected = distance < 450; // Radius detection...just outside of LOS Range
...
void PlayScene::handleEvents()
{
	...
	{
		m_pTarget->takeDamage(25); // or m_pTarget->setHealth(m_pTarget->getHealth() - 25);
